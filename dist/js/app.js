 ...
 */
    ...
    function initSliders() {
        if (document.querySelector(".car__items")) new swiper_core_Swiper(".car__items", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".car-investors__items")) new swiper_core_Swiper(".car-investors__items", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            speed: 800,
            navigation: {
                prevEl: ".car-investors-button-prev",
                nextEl: ".car-investors-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
    ...
    function addLabelForForm() {
        ...
        myPhone.addEventListener("keyup", (function(evt) {
            if (myPhone.value.includes("_")) {
                msg.textContent = "Заполните поле";
